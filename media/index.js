...
`}const Sg=(i,e)=>{const t=$g(i),s=Cg(i);return re`
        <template
            ...
            ${Hc({property:"cellElements",filter:cr('[role="cell"],[role="gridcell"],[role="columnheader"],[role="rowheader"]')})}
        >
        ...
        ${lr(t=>typeof t.value=="number",re`
                ...
                >
                    ...
                    <circle
                        class="determinate"
                        part="determinate"
                        style="stroke-dasharray: ${t=>Ya*t.percentComplete/100}px ${Ya}px"
                        cx="8px"
                        cy="8px"
                        r="7px"
                    ></circle>
...
`;class Yi extends me{constructor(){super(...arguments),this.percentComplete=0}valueChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}minChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}maxChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}connectedCallback(){super.connectedCallback(),this.updatePercentComplete()}updatePercentComplete(){const e=typeof this.min=="number"?this.min:0,t=typeof this.max=="number"?this.max:100,s=typeof this.value=="number"?this.value:0,n=t-e;this.percentComplete=n===0?0:Math.fround((s-e)/n*100)}}g([y({converter:bt})],Yi.prototype,"value",void 0);g([y({converter:bt})],Yi.prototype,"min",void 0);g([y({converter:bt})],Yi.prototype,"max",void 0);g([y({mode:"boolean"})],Yi.prototype,"paused",void 0);g([P],Yi.prototype,"percentComplete",void 0);const Yg=(i,e)=>re`
    <template
        role="radiogroup"
        aria-disabled="${t=>t.disabled}"
        aria-readonly="${t=>t.readOnly}"
...
`;class Xc extends me{}g([y({mode:"boolean"})],Xc.prototype,"disabled",void 0);const rm=(i,e)=>re`
...
`;class Mm extends Ms{connectedCallback(){super.connectedCallback(),this.circular||(this.circular=!0)}}const Nm=Mm.compose({baseName:"badge",template:qc,styles:Fm});function Bm(i,e,t,s){var n=arguments.length,o=n<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,t):s,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(i,e,t,s);else for(var a=i.length-1;a>=0;a--)(r=i[a])&&(o=(n<3?r(o):n>3?r(e,t,o):r(e,t))||o);return n>3&&o&&Object.defineProperty(e,t,o),o}const Hm=ye`
	${Me("inline-flex")} :host {
		outline: none;
		font-family: ${ht};
		font-size: ${qe};
...
`,Um=(i,e)=>ye`
	...
	${jm}
	${zm}
`;class ld extends yt{connectedCallback(){if(super.connectedCallback(),!this.appearance){const e=this.getAttribute("appearance");this.appearance=e}}attributeChangedCallback(e,t,s){e==="appearance"&&s==="icon"&&(this.getAttribute("aria-label")||(this.ariaLabel="Icon Button")),e==="aria-label"&&(this.ariaLabel=s),e==="disabled"&&(this.disabled=s!==null)}}Bm([y],ld.prototype,"appearance",void 0);const qm=ld.compose({baseName:"button",template:gg,styles:Um,shadowOptions:{delegatesFocus:!0}}),Wm=(i,e)=>ye`
	${Me("inline-flex")} :host {
		align-items: center;
		outline: none;
		margin: calc(${U} * 1px) 0;
...
`;class Gm extends _n{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Checkbox")}}const Jm=Gm.compose({baseName:"checkbox",template:Tg,styles:Wm,checkedIndicator:`
		<svg 
...
`;class Xm extends Fe{connectedCallback(){super.connectedCallback(),this.getAttribute("aria-label")||this.setAttribute("aria-label","Data Grid")}}const Km=Xm.compose({baseName:"data-grid",baseClass:Fe,template:yg,styles:Ym});class eb extends Le{}const tb=eb.compose({baseName:"data-grid-row",baseClass:Le,template:Sg,styles:Qm});class ib extends ii{}const sb=ib.compose({baseName:"data-grid-cell",baseClass:ii,template:kg,styles:Zm}),nb=(i,e)=>ye`
	${Me("block")} :host {
		border: none;
...
`;class Cb extends Yi{connectedCallback(){super.connectedCallback(),this.paused&&(this.paused=!1),this.setAttribute("aria-label","Loading"),this.setAttribute("aria-live","assertive"),this.setAttribute("role","alert")}attributeChangedCallback(e,t,s){e==="value"&&this.removeAttribute("value")}}const Sb=Cb.compose({baseName:"progress-ring",template:Jg,styles:$b,indeterminateIndicator:`
...
`;class Tb extends si{connectedCallback(){super.connectedCallback();const e=this.querySelector("label");if(e){const t="radio-group-"+Math.random().toString(16).slice(2);e.setAttribute("id",t),this.setAttribute("aria-labelledby",t)}}}const Ob=Tb.compose({baseName:"radio-group",template:Yg,styles:kb}),Ib=(i,e)=>ye`
	${Me("inline-flex")} :host {
		align-items: center;
		flex-direction: row;
		font-size: ${qe};
...
`;class Db extends Ms{connectedCallback(){super.connectedCallback(),this.circular&&(this.circular=!1)}}const _b=Db.compose({baseName:"tag",template:qc,styles:Ab}),Pb=(i,e)=>ye`
	${Me("inline-block")} :host {
		font-family: ${ht};
		outline: none;
		user-select: none;
